...
typedef struct {
    int owner;           /*!<  Joueur controlant la case */
    unsigned int nbDames;   /*!<  Nombre de dames sur la case (non utilise si
                             `owner == NOBODY.`) */
} Square;
...
typedef struct {
    ...
    unsigned int turn;          /*!< Numero du tour en cours (initialise a 0) */
